...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p 9a00dd97-a13c-46c7-8b0d-038fdeeede92
```

> `9a00dd97-a13c-46c7-8b0d-038fdeeede92` is the password of the certificate, you can change it to any password you want.
